...
*Purpose: Prompt user for five integers, use separate functions to return highest and lowest of the five.
*/
...
void maxInt(int, int, int, int, int);
void minInt(int, int, int, int, int);
...
int main()
{
	...
	maxInt(userNum1, userNum2, userNum3, userNum4, userNum5);
	minInt(userNum1, userNum2, userNum3, userNum4, userNum5);
...
//Should really create this algorithm myself but for simplicity and to teaching calling functions I chose to use min_element
void minInt(int num1, int num2, int num3, int num4, int num5)
{
	//Insert values into array
	int userSet[] = { num1, num2, num3, num4, num5 };
